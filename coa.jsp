...
<html>
<head>
<link rel = 'icon' href = 'img/coa2.png'></link>
...
<div class = 'container'>
	<div class = 'row'>
		<div class = 'col-lg-12'>
		<img src = "img/coa2.png" style = "padding-left: 390px;padding-top: 50px;"></img><br/><br/>
		<h3 style="padding-left:460px;">COA</h3><br/><br/>
	...
	<div class = 'row'>
			...
			<form action="validate.jsp" method = 'get'>
				...
				%>
				<input type = 'hidden' name = 'table_name' value = 'coa'></input><br/>
				<br/>
