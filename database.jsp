...
<html>
<head>
<link rel = 'icon' href = 'img/db.jpg'></link>
...
<div class = 'container'>
	<div class = 'row'>
		<div class = 'col-lg-12'>
		<img src = "img/db3.png" style = "padding-left: 442px;padding-top: 50px;"></img><br/><br/>
		<h3 style="padding-left:460px;">DATABASE</h3><br/><br/>
	...
	<div class = 'row'>
			...
			<form action="validate.jsp" method = 'get'>
				...
				String sql ="SELECT * FROM database_question";
				...
				%>
				<input type = 'hidden' name = 'table_name' value = 'database_question'></input><br/>
				<br/>
