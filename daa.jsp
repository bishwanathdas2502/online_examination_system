...
<html>
<head>
<link rel = 'icon' href = 'img/daa2.png'></link>
...
<div class = 'container'>
	<div class = 'row'>
		<div class = 'col-lg-12'>
		<img src = "img/daa2.png" style = "padding-left: 410px;padding-top: 50px;"></img><br/><br/>
		<h3 style="padding-left:470px;">DAA</h3><br/><br/>
	...
	<div class = 'row'>
			...
			<form action="validate.jsp" method = 'get'>
				...
				%>
				<input type = 'hidden' name = 'table_name' value = 'daa'></input><br/>
				<br/>
